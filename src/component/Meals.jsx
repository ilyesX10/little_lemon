  ...
  return (
    <section className="p-4 bg-transparent text-[var(--text)] mt-20">
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
        <div className="flex flex-col space-y-4 bg-[var(--surface)] rounded-[var(--radius)] shadow-lg">
          ...
          <p className="text-[length:var(--text-body)] text-[var(--primary)] p-4">The famous Greek salad of crispy lettuce, peppers, tomatoes, and our Chicago special feta cheese, garnished with olive oil and red wine vinegar.</p>
        ...
        <div className="flex flex-col space-y-4 bg-[var(--surface)] rounded-[var(--radius)] shadow-lg">
          ...
          <p className="text-[length:var(--text-body)] text-[var(--primary)] p-4">The perfect complement to your meal, our Bruchetta is made with fresh tomatoes, basil, and mozzarella cheese.</p>
          <a href="order a delivery" className="flex justify-start items-center p-4">
            <span className="font-[var(--weight-bold)] text-[length:var(--text-lead)] text-[var(--text)] mr-2">Order a delivery</span>
            <MdDeliveryDining className="text-[var(--text)] w-6 h-6" />
          </a>
        ...
        <div className="flex flex-col space-y-4 bg-[var(--surface)] rounded-[var(--radius)] shadow-lg">
            ...
            <p className="text-[length:var(--text-body)] text-[var(--primary)] p-4">The perfect ending to your meal, our Lemon Dessert is a refreshing blend of lemons, sugar, and cream.</p>
            <a href="order a delivery" className="flex justify-start items-center p-4">
                <span className="font-[var(--weight-bold)] text-[length:var(--text-lead)] text-[var(--text)] mr-2">Order a delivery</span>
                <MdDeliveryDining className="text-[var(--text)] w-6 h-6" />
            </a>
